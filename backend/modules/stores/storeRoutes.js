...
import { createStore, getStores, getStoreById, updateStore, deleteStore, getMyStores, getMerchantStats, getMerchantBalance, getMerchantPayouts, getMerchantMapStats, toggleStoreStatus, requestWithdrawal } from './storeController.js';
...
router.post('/withdraw', protect, authorizeRoles('merchant'), requestWithdrawal);
