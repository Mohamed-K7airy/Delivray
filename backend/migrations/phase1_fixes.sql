...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS delivery_fee NUMERIC(10, 2) DEFAULT 45.00; -- Updated for EGP
ALTER TABLE orders ADD COLUMN IF NOT EXISTS delivery_address TEXT;

-- 3. Update existing orders (optional, but good for data consistency)
UPDATE orders SET subtotal = total_price - 45.00, delivery_fee = 45.00 WHERE delivery_fee IS NULL; -- Updated for EGP
