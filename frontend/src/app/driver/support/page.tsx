...
const Card = ({ icon: Icon, title, description }: { icon: any, title: string, description: string }) => (
  <div className="max-w-4xl mx-auto py-20 text-center space-y-12">
    ...
    <div className="space-y-4">
       <h1 className="text-6xl font-black tracking-tighter uppercase italic text-white">Support Center</h1>
       <p className="text-gray-500 text-xl font-bold max-w-lg mx-auto leading-relaxed">Need help? Driver Hub support is available 24/7 to resolve disputes, vehicle issues, or account questions.</p>
    </div>
  </div>
);
