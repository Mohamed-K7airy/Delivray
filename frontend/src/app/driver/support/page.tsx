...
export default function DriverSupport() {
  return (
    <div className="space-y-6 pb-24 max-w-2xl">
      <div>
        <h1 className="text-3xl font-black text-[#111111] tracking-tighter">Support</h1>
      ...
      <div className="grid grid-cols-2 gap-4">
        {[
          { icon: <MessageSquare size={20} />, label: 'Live Chat', desc: 'Chat with a dispatch agent now', color: '#d97757', bg: '#fef3f2' },
          ...
          >
            ...
            <p className="text-xs font-black text-[#111111] mb-1">{item.label}</p>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-50">
          <p className="text-sm font-black text-[#111111]">Common Questions</p>
        </div>
        <div className="divide-y divide-gray-50">
          {[
            ...
            <div key={i} className="px-6 py-4">
              <p className="text-xs font-black text-[#111111] mb-1">{faq.q}</p>
      ...
      <div className="flex items-center gap-3 px-4 py-3 bg-[#f0fdf4] rounded-xl border border-green-100 text-green-600">
        <ShieldCheck size={16} />
        <span className="text-[10px] font-black uppercase tracking-wider">Driver support is available 24/7</span>
      </div>
    </div>
  );
}
