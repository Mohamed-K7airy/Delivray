...
const Card = ({ icon: Icon, title, description }: { icon: any, title: string, description: string }) => (
  <div className="max-w-4xl mx-auto py-20 lg:py-32 text-center space-y-12">
    ...
    <div className="space-y-6">
       ...
       <p className="text-[#888888] text-base lg:text-xl font-bold max-w-lg mx-auto leading-relaxed border-t border-gray-50 pt-8 uppercase tracking-widest">{description}</p>
    </div>
  </div>
);
