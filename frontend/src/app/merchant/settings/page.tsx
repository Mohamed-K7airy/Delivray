  ...
  return (
    <div className="max-w-7xl mx-auto space-y-12">
       ...
       <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <button className="bg-[#0f172a] text-white px-8 py-4 rounded-xl font-bold uppercase tracking-widest text-xs flex items-center space-x-3 shadow-md hover:bg-[#c2654a] transition-all">
             <Save size={18} />
