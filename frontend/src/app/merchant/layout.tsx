...
export default function MerchantLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!mounted || !token || user?.role !== 'merchant') {
     return (
        <div className="min-h-screen bg-[#111111] flex items-center justify-center font-black">
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white flex relative overflow-x-hidden">
