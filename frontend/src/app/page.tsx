  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        ...
        {!token && (
          ...
          >
            ...
            <motion.div 
              ...
              className="relative mb-16 md:mb-28 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-10 md:gap-0 pt-4"
            >
              ...
              <div className="w-full md:w-[55%] relative z-10">
                <motion.div 
                  ...
                  className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-md px-5 py-2.5 rounded-full mb-8 border border-white/10 shadow-lg"
                >
                  <Sparkles size={16} className="text-primary" />
                  <span className="text-white font-bold tracking-wide uppercase text-sm">Lightning fast delivery</span>
                </motion.div>
                ...
                <motion.h1 
                  ...
                  className="text-6xl sm:text-7xl md:text-8xl font-black text-white mb-6 leading-[0.95] tracking-tighter"
                >
                ...
                <motion.p 
                  ...
                  className="text-gray-400 text-base sm:text-lg md:text-xl mb-10 max-w-lg leading-relaxed font-medium mx-auto md:mx-0"
                >
                ...
                >
                  <div className={`flex items-center bg-[#262624] p-1.5 rounded-2xl border transition-all duration-300 w-full ${searchFocused ? 'border-primary ring-4 ring-primary/10' : 'border-white/5'}`}>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 outline-none text-white bg-transparent placeholder-gray-500 font-bold text-base"
                    />
                    <motion.button 
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="bg-primary text-white px-6 py-3 rounded-xl font-black text-sm shadow-lg shadow-primary/20 shrink-0 whitespace-nowrap"
                    >
      ...
      <motion.div layout transition={{ duration: 0.5, ease: 'circOut' }}>
        ...
        >
          <h2 className="text-4xl font-black text-white tracking-tighter">Explore Categories</h2>
          <div className="flex space-x-4 overflow-x-auto pb-4 scrollbar-hide">
            {categories.map((type, i) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`whitespace-nowrap px-8 py-4 rounded-2xl font-black text-sm tracking-widest uppercase transition-all shadow-lg ${
                  filterType === type 
        ...
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {[1,2,3,4,5,6,7,8].map(i => (
              <div key={i} className="animate-pulse bg-white/5 backdrop-blur-md rounded-[2rem] p-5 shadow-sm h-80 border border-white/5">
                <div className="bg-white/5 h-40 rounded-[1.5rem] mb-6"></div>
            ...
            {stores.map((store) => (
              <motion.div variants={itemVariants} key={store.id}>
                <Link href={`/store/${store.id}`} className="block group">
                  <div className="bg-[#262624]/40 backdrop-blur-md rounded-[2.5rem] p-4 border border-white/5 hover:border-white/10 transition-all duration-500 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] group-hover:-translate-y-2">
                    ...
                    <div className="relative h-60 w-full rounded-[2rem] overflow-hidden mb-6">
                      ...
                      <div className="absolute top-4 right-4 bg-black/40 backdrop-blur-xl px-3 py-1.5 rounded-xl border border-white/10 flex items-center shadow-2xl">
        ...
        <section id="services" className="py-24 border-t border-white/5">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">Our <span className="text-primary italic">Services.</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                key={idx}
                whileHover={{ y: -10 }}
                className="bg-[#262624]/40 backdrop-blur-xl p-8 rounded-[2.5rem] border border-white/5 hover:border-primary/20 transition-all group"
              >
                <div className="mb-6 w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                  {service.icon}
                </div>
                <h3 className="text-xl font-black text-white mb-4 uppercase tracking-wider">{service.title}</h3>
        ...
        <section id="tracking" className="py-24 border-t border-white/5">
          <div className="bg-gradient-to-br from-primary/10 to-transparent p-12 md:p-20 rounded-[4rem] border border-primary/20 flex flex-col md:flex-row items-center gap-12 overflow-hidden relative">
            <div className="flex-1 z-10">
              ...
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 leading-tight">Elite <span className="text-primary italic">Tracking.</span></h2>
              <p className="text-gray-400 text-lg mb-10 max-w-md font-medium">Watch your order's every move with our high-fidelity, sub-second tracking technology.</p>
              <button 
                onClick={handleExperienceClick}
                className="bg-primary text-white px-10 py-5 rounded-full font-black text-xs uppercase tracking-[0.2em] hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-primary/20"
              >
                Experience It Now
              </button>
            </div>
            <div className="flex-1 relative w-full h-80 bg-gray-900/50 rounded-[3rem] border border-white/5 overflow-hidden flex items-center justify-center">
        ...
        <section id="pricing" className="py-24 border-t border-white/5 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-12 uppercase tracking-tight">Simple <span className="text-primary italic">Pricing.</span></h2>
          <div className="max-w-4xl mx-auto bg-[#262624]/40 backdrop-blur-xl p-10 md:p-16 rounded-[4rem] border border-white/5">
        ...
        <section id="partners" className="py-24 border-t border-white/5">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">Become a <span className="text-primary italic">Partner.</span></h2>
          ...
          <div className="flex flex-wrap justify-center gap-6">
             <button className="bg-white text-black px-12 py-6 rounded-full font-black text-xs uppercase tracking-[0.2em] hover:scale-105 transition-all">Merchant Portal</button>
             <button className="bg-[#262624] text-white px-12 py-6 rounded-full font-black text-xs uppercase tracking-[0.2em] border border-white/10 hover:bg-white/5 transition-all">Driver App</button>
          </div>
        </section>
      </motion.div>
    </div>
