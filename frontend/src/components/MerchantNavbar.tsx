...
export default function MerchantNavbar({ isCollapsed, isMobileOpen, setIsMobileOpen }: MerchantNavbarProps) {
    ...
    <nav className="h-16 sm:h-24 bg-white/80 border-b border-gray-100 flex items-center justify-between px-4 sm:px-8 lg:px-12 sticky top-0 z-50 backdrop-blur-3xl transition-all duration-500">
      <div className="flex items-center gap-x-4 sm:gap-x-24">
        ...
        <div className="hidden md:flex items-center space-x-6 pr-6 border-r border-gray-100">
          <button 
            onClick={() => toast.info('Neural Search initiated...', { icon: <Search className="text-[#0f172a]" /> })}
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <div className="hidden sm:block text-left">
               <p className="text-[10px] font-bold text-[#111111] uppercase tracking-widest leading-none mb-1">{user?.name || 'Merchant'}</p>
              ...
              >
                ...
                <div className="space-y-1 relative z-10">
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest">Control Center</span>
                  </button>
