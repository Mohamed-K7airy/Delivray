...
export default function StoreToggle({ storeId, initialStatus }: StoreToggleProps) {
  ...
  return (
    <div className="flex items-center justify-between p-6 bg-[#f8fafc] rounded-2xl border border-gray-100 mb-8">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h4 className="text-sm font-bold uppercase tracking-tighter text-[#111111]">
      ...
      <button
        ...
        disabled={loading}
        className={`px-6 py-3 rounded-xl font-bold uppercase tracking-widest text-[10px] transition-all transform active:scale-95 shadow-sm ${
          isOpen 
